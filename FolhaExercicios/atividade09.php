...
<?php
    ...
    function calculoJuroComposto($capital, $qtdParcelas, $taxaJuros) {
        return $capital * (1 + $taxaJuros)** $qtdParcelas;
    }
    function calculoValorParcela($montande, $qtdParcelas) {
    ...
    function chamadaPrincipal() {
        try {
            ...
            switch ($qtdParcelas) {
                case 24:
                    $montante = calculoJuroComposto($capital, $qtdParcelas, 0.020);
                    $valorParcela = calculoValorParcela($montante, $qtdParcelas);
                    break;
                case 36:
                    $montante = calculoJuroComposto($capital, $qtdParcelas, 0.023);
                    $valorParcela = calculoValorParcela($montante, $qtdParcelas);
                    break;
                case 48:
                    $montante = calculoJuroComposto($capital, $qtdParcelas, 0.026);
                    $valorParcela = calculoValorParcela($montante, $qtdParcelas);
                    break;
                case 60:
                    $montante = calculoJuroComposto($capital, $qtdParcelas, 0.029);
                    $valorParcela = calculoValorParcela($montante, $qtdParcelas);
                    break;
            }
